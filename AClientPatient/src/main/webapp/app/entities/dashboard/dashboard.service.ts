...
export class DashboardService {
  ...
  getLatestVital(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IPatientVital[]>(this.resourceUrl1+'patients-vitals', { params: options, observe: 'response' });
  }
